...
// Supbase is IDE, Postgres for the ? (Auth? Database?)
// MAc Dark mode affects white and back background I see (Add an explicit and no overriding of thematics) (Explicitly make it black/darkmode) (get people to get on safari vs chrome, on chrome it loks like white mode)
// Make Automatic know that posting makes it right 
// FOCUS ON SOUND WHEN MAKING IT FEEL NICE (GET INSPIRITATION FROM POKER)
// Safety vs security? (Stats)
// Put the fold warning in the middle of the game 
// Make it so that people dont disconnect if they disconnect (local, session, cookies?) (Local storage is what I would want?)
// Also I think Claude made some changes thats moves me on to the next steps? (just sql stuff)

// I really like the name Headsup (Headsup!) ??

// Accounts, acocunts going into a server, make like multiple game rooms, like a lobby
